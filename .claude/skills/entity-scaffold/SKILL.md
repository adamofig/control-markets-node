...
description: Create a new NestJS entity/module/collection following the project scaffold pattern. Use when the user asks to create a new entity, module, resource, collection, or NestJS feature.
---

# Skill: Create New Entity (Entity T Framework)

The entity scaffold pattern creates a new model that can potentially be used in multiple places. The frontend uses it a lot, providing an easy and standardized way of calling endpoints.
...
> The entity can have any property. `id`, `name`, `description`, and `auditable` are mandatory unless the user says otherwise.
